      ...
      <div className="container-max">
        ...
        >
          {practiceAreas.map((area, index) => (
            <div
              key={area.title}
              className={`bg-warm-white p-5 md:p-8 border-b-2 border-transparent hover:border-forest-green transition-all duration-500 group ${
                visible
            ...
            >
              <div className="text-forest-green mb-3 md:mb-5 group-hover:text-sage-green transition-colors duration-300">
                {iconMap[area.icon]}
              </div>
              <h3 className="font-cormorant text-xl md:text-2xl font-semibold text-charcoal mb-2 md:mb-3">
                {area.title}
              </h3>
