        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          <div className="space-y-8">
              ...
              <ul className="space-y-5">
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="tel:+254705269529" className="font-outfit text-base text-charcoal md:pointer-events-none md:cursor-default hover:text-forest-green md:hover:text-charcoal transition-colors">0705 269 529</a>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                ...
                <li className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-outfit text-base text-charcoal">Doctor's Plaza, Next to KCB Bank Kiambu,<br />6th Floor, Suite 603</p>
                  </div>
                </li>
                <li className="flex items-start gap-4">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div>
                <textarea {...register("message")} placeholder="Briefly describe your legal matter... (optional)" rows={5} className={`${inputClass} resize-none`} />
              </div>
              ...
              {status === "error" && (
                <p className="font-outfit text-sm text-red-500 text-center">Something went wrong. Please try again or email us directly at nkiriro@proton.me</p>
              )}
            </form>
          </div>
        </div>
